...
const cocktails = [
  ...
  { name:"Aviation", glass:"Chilled Coupe Glass", garnish:"No garnish",
    ...
    ingredients:[ {amt:"2 oz.",item:"Gin"}, {amt:".75 oz.",item:"Luxardo Maraschino"}, {amt:".5 oz.",item:"Lemon Juice"}, {amt:".25 oz.",item:"Crème de Violet Liqueur"} ] },
  ...
  { name:"Mary Pickford", glass:"Chilled Coupe Glass", garnish:"Cherry, Skewered",
    ...
    ingredients:[ {amt:"2 oz.",item:"Rum"}, {amt:".75 oz.",item:"Luxardo Maraschino"}, {amt:"1.5 oz.",item:"Pineapple Juice"}, {amt:"1 tsp.",item:"Cherry Juice"} ] },
